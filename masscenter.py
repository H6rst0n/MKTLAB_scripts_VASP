...
masscenter_x=massOfAllAtom_x/allmass
masscenter_y=massOfAllAtom_y/allmass
masscenter_z=massOfAllAtom_z/allmass

print("Molecular centroid is (", '%f'%masscenter_x,",", '%f'%masscenter_y,",", '%f'%masscenter_z,").")
