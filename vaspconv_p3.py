...
try:    
    with open("CONTCAR","r") as CONTCAR:        # get CONTCAR infomation
        ...
        if contcar[7][0][0] == "s" or contcar[7][0][0] == "S":
                ...
                SelectiveDynamics = 0
                del contcar[0:8]
        nfreeAtom = 0                           # How many atoms have variable degrees of freedom (here just generate a variable first)

except IOError:
        sys.stderr.write(FAIL)
        sys.stderr.write("There was a problem opening the CONTCAR file. Does it exist at all?")
